...
class ErrorHandler{
    ...
    public function exceptionHandler($e){
        error_log("[" . date('Y-m-d H:i:s')."] Text error: {$e->getMessage()} | File: {$e->getFile()} | Line: {$e->getLine()}\n===========================\n",3, __DIR__.'/errors.log');
...
//try{
//    if (empty($test)){
//        throw new Exception('Oops! Exeption!');
//    }
//}catch (Exception $e){
//    var_dump($e);
//}

//throw new NotFoundException('455555');

throw new Exception("212121");